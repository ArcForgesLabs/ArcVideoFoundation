    ...
    switch (display) {
        ...
        case kTimecodeSeconds: {
            ...
            if (display == kTimecodeSeconds) {
                ...
                int rounded_frame_rate = static_cast<int>(std::llround(frame_rate));
...
rational Timecode::timecode_to_time(std::string timecode, const rational& timebase, const Timecode::Display& display,
    ...
    switch (display) {
        ...
        case kTimecodeSeconds: {
            ...
            double frame_rate = timebase.flipped().toDouble();
            int rounded_frame_rate = static_cast<int>(std::lround(frame_rate));
            ...
            if (display == kTimecodeSeconds) {
                ...
                time = rational::fromDouble(static_cast<double>(hours) * 3600 + static_cast<double>(mins) * 60 + secs);
            } else {
