...
public:
    ...
    [[nodiscard]] SampleFormat to_packed_equivalent() const { return to_packed_equivalent(f_); }
    ...
    [[nodiscard]] SampleFormat to_planar_equivalent() const { return to_planar_equivalent(f_); }
