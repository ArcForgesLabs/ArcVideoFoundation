...
#ifndef ARCVIDEO_FOUNDATION_AUDIOPARAMS_H
#define ARCVIDEO_FOUNDATION_AUDIOPARAMS_H
...
public:
    ...
    [[nodiscard]] rational sample_rate_as_time_base() const { return {1, sample_rate()}; }
...
#endif  // ARCVIDEO_FOUNDATION_AUDIOPARAMS_H
