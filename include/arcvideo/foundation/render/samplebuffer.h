...
#ifndef ARCVIDEO_FOUNDATION_SAMPLEBUFFER_H
#define ARCVIDEO_FOUNDATION_SAMPLEBUFFER_H
...
public:
    ...
    [[nodiscard]] int channel_count() const { return static_cast<int>(data_.size()); }
...
#endif  // ARCVIDEO_FOUNDATION_SAMPLEBUFFER_H
